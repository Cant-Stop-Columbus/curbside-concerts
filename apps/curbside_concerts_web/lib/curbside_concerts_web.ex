defmodule CurbsideConcertsWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: CurbsideConcertsWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/curbside_concerts_web/templates",
        namespace: CurbsideConcertsWeb
